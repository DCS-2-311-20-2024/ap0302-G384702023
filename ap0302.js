...
car.add(mesh);
  ...
  //     右窓
  mesh = new THREE.Mesh(new myTriangleGeometry( v[5], v[4], v[6]), glassMaterial);
  car.add(mesh);
  mesh = new THREE.Mesh(new myTriangleGeometry( v[6], v[7], v[5]), glassMaterial);
  car.add(mesh);

  //     前窓
  mesh = new THREE.Mesh(new myTriangleGeometry( v[4], v[0], v[2]), glassMaterial);
  car.add(mesh);
  mesh = new THREE.Mesh(new myTriangleGeometry( v[2], v[6], v[4]), glassMaterial);
  car.add(mesh);
  //     後窓
  ...
  mesh = new THREE.Mesh(new THREE.CylinderGeometry(tyreR, tyreR, tyreW, 16, 1 ), tyreMaterial);
  mesh.rotation.z = Math.PI/2;
  mesh.position.set(-3/14*carL, -carH, -carW/2);
  car.add(mesh);
  mesh = new THREE.Mesh(new THREE.CylinderGeometry(tyreR, tyreR, tyreW, 16, 1 ), tyreMaterial);
  mesh.rotation.z = Math.PI/2;
  mesh.position.set(3/14*carL, -carH, -carW/2);
